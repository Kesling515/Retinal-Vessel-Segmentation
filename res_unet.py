...
def train(DATASET="DRIVE", crop_size=64, need_au=True, ACTIVATION='ReLU', dropout=0.2, batch_size=20,
    ...
    print('-' * 35)
    model = get_res_unet(minimum_kernel=minimum_kernel, do=dropout, size=crop_size, activation=activation)
...
if __name__ == "__main__":
    ...
    predict(crop_size=64, epochs=5, stride_size=8, DATASET='DRIVE')